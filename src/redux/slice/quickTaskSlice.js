...
export const uniqueChecklistTaskData = createAsyncThunk(
  ...
  async ({ page = 0, pageSize = 50, nameFilter = '', freqFilter = '', append = false, userRole = '', userDept = '', userDiv = '', userName = '', deptFilter = '', divFilter = '', search = '' }) => {
    const result = await fetchChecklistData(page, pageSize, nameFilter, freqFilter, userRole, userDept, userDiv, userName, deptFilter, divFilter, search);
...
export const uniqueDelegationTaskData = createAsyncThunk(
  ...
  async ({ page = 0, pageSize = 50, nameFilter = '', freqFilter = '', append = false, userRole = '', userDept = '', userDiv = '', userName = '', deptFilter = '', divFilter = '', search = '' }) => {
    const result = await fetchDelegationData(page, pageSize, nameFilter, freqFilter, userRole, userDept, userDiv, userName, deptFilter, divFilter, search);
